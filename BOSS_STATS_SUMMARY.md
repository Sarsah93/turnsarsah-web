...
## 🐊 챕터 3B - 늪지대 (Chapter 3B - Swamp)

| 스테이지 | 보스이름 | HP | ATK | 보스 패시브(기본 잠김 외) | 부여 상태이상 | 규칙(Rule) | 특수룰 요약 | 기타 |
| :---: | :--- | :---: | :---: | :--- | :--- | :--- | :--- | :--- |
| **1** | ALLIGATOR SNAPPING TURTLE | 160 | 20 | 재생, 경감, 반사 | 출혈(20%) | HARDNESS | 투페어 이상만 타격 가능 | - |
| **2** | MURLOC | 180 | 20 | 재생 | 진흙(20%) | MUDDED_20PCT | 5턴 마다 플레이어 핸드 1개 BANNED | - |
| **3** | CROCODILE | 180 | 25 | - | 과출혈(20%), 중독(10%) | DEATHROLL | 플레이어 SWAP 시 즉시 공격 | - |
| **4** | LIZARD SKINK | 200 | 15 | 재생 | 출혈(20%), 중독(10%) | AUTOTOMY | 2턴 마다 플레이어 공격력 30% 감소 | - |
| **5** | LIZARD MAN | 250 | 20 | - | 과출혈(30%) | CAMOUFLAGE | 3턴 마다 보스 무조건 회피 | - |
| **6** | LIZARD SLANN | 200 | 15 | - | 중독(40%) | INITIALTORY | 매 턴 핸드 초기화 & 조커 확률 감소 | 전리품(TR_3B_06) |
| **7** | LIZARD SAURUS | 300 | 25 | 경감(35%), 재생 | - | HOLD_BREATH | 보스 2회 공격 성공 시 다음 턴 무적 | - |
| **8** | TROGLODON | 400 | 20 | - | 중독(20%), 진흙(40%) | MUDDED_40PCT | 5턴 마다 보스 ATK +10 (영구) | - |
| **9** | LIZARD KROXIGOR | 350 | 30 | - | 출혈(40%), 쇠약(40%) | AWAKENING_3B | HP 50% 이하 시 체력 풀회복 & ATK+20 | - |
| **10** | **LIZARD KING** | 380 | 35 | 줄기세포 성장 | 과출혈(20%), 중독(20%) | STEM_CELL | 매 턴 성장(HP/ATK/Avoid) | 전리품(TR_3B_10) |
