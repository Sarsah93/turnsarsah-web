...
export const CHAPTERS: Record<string, ChapterConfig> = {
  ...
  '2A': {
    ...
    stages: {
      1: { name: 'STAGE 1', bossName: 'MUMMY', hp: 180, atk: 15, level: 11, rule: 'REVIVE_50%' },
      ...
      4: { name: 'STAGE 4', bossName: 'SAND NIDDLE LIZARD', hp: 250, atk: 20, level: 14, rule: 'NO_DMG_UNDER_50' },
      5: { name: 'STAGE 5', bossName: 'SAND SCORPION', hp: 250, atk: 15, level: 15, rule: 'FORCE_SWAP' },
      6: { name: 'STAGE 6', bossName: 'DESERT VULTURES', hp: 200, atk: 15, level: 16, rule: 'TRIPLE_ATTACK' },
      7: { name: 'STAGE 7', bossName: 'SAND GOLEM', hp: 320, atk: 35, level: 17, rule: 'TWO_TIMES_PARALYZE_50' },
      8: { name: 'STAGE 8', bossName: 'SAND WYVERN', hp: 300, atk: 20, level: 18, rule: 'NO_DMG_STRAIGHT_BLIND_1' },
      9: { name: 'STAGE 9', bossName: 'SAND DEATHWARM', hp: 360, atk: 20, level: 19, rule: 'RANDOM_BLIND_BAN_1' },
      10: { name: 'STAGE 10', bossName: 'SPHINX', hp: 330, atk: 40, level: 20, rule: 'PUZZLE' },
    }
  },
  '2B': {
